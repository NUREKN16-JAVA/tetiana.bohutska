package ua.nure.kn.bohutska.usermanagement.gui;
...
import ua.nure.kn.bohutska.usermanagement.db.MockDaoFactory;
import ua.nure.kn.bohutska.usermanagement.util.Message;
...
public class MainFrameTest extends JFCTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        User expectedUser = new User(1000L, "Tanya", "Bogutskaya", new Date());
